...
# do lrs finetune
CUDA_VISIBLE_DEVICES=1 python -m pdb -c continue RAD-NeRF/lrs_finetune.py $data_path --workspace trial_lrs/ --exp_eye --finetune_lips --lrs --iters 1000000 --head_ckpt $pretrained_model
