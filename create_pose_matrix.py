...
#edited from process.py

parser = ap.ArgumentParser()
parser.add_argument('--base_dir', type=str, default='')
parser.add_argument('--ori_imgs_dir',type=str,default='')
args=parser.parse_args()
base_dir=args.base_dir
ori_imgs_dir=args.ori_imgs_dir
# base_dir = '/home/paz/data/lrs3/trackingtest/1PNX6MSdVsk/00001'
...
def save_transforms(base_dir, ori_imgs_dir):
    ...
    with open(os.path.join(base_dir, 'transforms_train.json'), 'w') as fp:
